...
/**
 * Default API host. An operator running their own deployment of the
 * gateway sets PAYMENT_GATEWAY_API_URL rather than passing `baseUrl` at
 * every call site — their integrators' code then reads the same as ours.
 * An explicit `baseUrl` in the constructor still wins over both.
 */
export const API_BASE_URL =
  (typeof process !== "undefined" && process.env?.PAYMENT_GATEWAY_API_URL) ||
  "https://payment-gateway-backend-teal.vercel.app";
