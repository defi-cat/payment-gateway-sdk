 ...
 * @property {"invoice.created"|"invoice.confirming"|"invoice.underpaid"|"invoice.refunded"} event
 * @property {string} invoice_id
 * @property {number|string} amount
 * @property {string} currency
 ...
 * @property {number} [refunded_amount] invoice.refunded only — the merchant's own send, recorded (non-custodial platform)
 * @property {string} [refund_address] invoice.refunded only
 * @property {string|null} [refund_tx_hash] invoice.refunded only — null if recorded before sending
 * @property {string} [refunded_at] invoice.refunded only
 */
